      ...
      console.log(_this.page)
        setTimeout(()=>{
          ...
          .then(res=>{
            ...
            let newList = _this.chatMessageList
            for (let it of  res.list){
              _this.chatMessageList.unshift(it)
            }
            for (let it of _this.chatMessageList) {
              //push 指定的文本
                if(it.msgType=="groupMap"){
                  if(typeof it.msgObj.map=='string'){
              ...
              let height = document.getElementById('socketMessageListUl').offsetHeight
              let scroll = document.getElementById('socketMessageList')
              scroll.scrollTop = height/_this.page
              _this.loading = false
          }).catch(err=>{
            console.log(err)
          })
